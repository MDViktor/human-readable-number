module.exports = function toReadable (number) {
  ...
  if ((number/10) < 1) {return firstTen.split(' ')[number];}
    ...
    else if (number%10 === 0 && number < 100) {return `${firstHundred.split(' ')[Math.floor(number/10)]}`;}
      ...
      if (Math.floor(number%100) >= 1 && Math.floor(number%100) < 10) {return `${firstTen.split(' ')[Math.floor(number/100)]} hundred ${firstTen.split(' ')[number - (Math.floor(number/100)*100)]}`;}
        ...
        else if (Math.floor(number%100) >= 20 && Math.floor(number%100) < 100) {return `${firstTen.split(' ')[Math.floor(number/100)]} hundred ${firstHundred.split(' ')[(number - Math.floor(number/100)*100 - number%10)/10]} ${firstTen.split(' ')[Math.floor(number%10)]}`;}
    }
  }
